...
foreach $ntel (1..4) {
    ...
    print OUT "0, 4,$start,$end,6, 4,$start,$end,4, 16,0.5,16.5, 200,0,30, '$telnames[$ntel] Ecal vs nstrip'\n";
    print OUT "0, 4,$start,$end,6, 4,$start,$end,3, 16,0.5,16.5, 200,0,10000, '$telnames[$ntel] Traw vs nstrip'\n";
}
